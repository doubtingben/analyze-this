...
void main(List<String> args) async {
  await build(args, (input, output) async {
    ...
    final minVersionFlag = () {
      if (os != OS.iOS) return const <String>[];
      final version = codeConfig.iOS.targetVersion.toString();
      if (codeConfig.iOS.targetSdk == IOSSdk.iPhoneSimulator) {
        return <String>['-mios-simulator-version-min=$version'];
      }
      return <String>['-miphoneos-version-min=$version'];
    }();
    final cFlags = <String>[
      ...minVersionFlag,
      '-isysroot',
