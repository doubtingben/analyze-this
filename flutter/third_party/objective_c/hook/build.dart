...
String minOSVersion(CodeConfig codeConfig) {
  if (codeConfig.targetOS == OS.iOS) {
    // Force 12.0 to match the Info.plist generated by Flutter for the framework.
    // This prevents "Invalid Bundle" errors where Binary MinOS (e.g. 14.0) > Info.plist MinOS (12.0).
    final version = '12.0';
