...
@app.get("/login", dependencies=[Depends(RateLimiter(10, 60))])
...
@app.post("/api/share", dependencies=[Depends(check_csrf), Depends(RateLimiter(20, 60))])
...
@app.post("/api/items/{item_id}/notes", dependencies=[Depends(check_csrf), Depends(RateLimiter(20, 60))])
...
@app.get("/api/search", dependencies=[Depends(RateLimiter(20, 60))])
